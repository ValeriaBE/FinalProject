...
Potential analysis could include a regression table--which would show perceived competence by gender identity. Also a word cloud could be created to see media descriptors about gender identity. We could collect media articles that mention political leaders of various gender identies and use sentiment analysis to figure out how certain adjectives that allude to competence differ by gender identity. 
